...
<footer id="footer">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 mt-5 mt-md-0  footer-contact">
            ...
            <p>
              ...
              Concepcion, 2316 Tarlac<br>
              <strong>Phone:</strong> (045)923-0537<br>
              <strong>Email:</strong>immaculate_cpn2000@yahoo.com.ph<br>
            </p>
          </div>
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="me-md-auto text-center text-md-start">
        <div class="copyright">
          &copy; Copyright <strong><span>Immaculate Concepcion Polyclinic Hospital</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
          ...
          Designed by Daveonwork IT Solution
        </div>
     </div>
  </footer>
  <!-- End Footer -->
