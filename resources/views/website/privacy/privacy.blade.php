            ...
            <div class="section-title">
                <h2> Our Privacy Policy </h2>
                    ...
                    <!-- 1. The data we collect -->
                        ...
                        <ol>
                            <li>Basic personal information: full name, address, contact information, birth date, occupation, social status, and etc.</li>
                            <li>Medical history and supporting documents.</li>
                            <li>Results from laboratory, radiology, or any other ancillary services.</li>
                            <li>Any other information that we may require to render healthcare services.</li>
                        </ol>
                        </div>
                    ...
                    <div class="px-4">
                        <ol>
                            ...
                            <li>To report to the respective government agencies (i.e. Department of Health) about certain diseases and conditions, as required by law.</li>
                            <li>To submit information to insurance companies (i.e. PhilHealth).</li>
                            <li>To store as historical data for the purposes of statistical or scientific research.</li>
                        </ol>
                    </div>
                    ...
                    <div class="px-4">
                        ...
                        <p class="text-indent text-justify">
                        The personal information we collected will be retained for fifteen (15) years, in accordance with the Data Privacy Act of 2012.           
                            </p>
                    </div>
                    ...
                    <div class="px-4">
                        ...
                        <p class="text-justify text-indent">
                        We understand the sensitivity of utilizing cookies which is why we will only use cookies when you agree to our Privacy Policy.        
                        </p>
